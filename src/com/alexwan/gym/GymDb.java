...
public class GymDb extends ContentProvider {
	...
	public final static String AUTORITY = "com.alexwan.gym";
	public final static Uri CONT_URI = Uri.parse("content://" + AUTORITY);
	
	public static final class ARGS {
		public static final String TRAIN_ID = "training_id";
		public static final String EXERC_ID = "exercise_id";
	...
	public static final class TRAINING {
		...
		public static final Uri _URI = Uri.withAppendedPath(CONT_URI, _TABLE);
	...
	static {
		...
		sUriMatcher.addURI(AUTORITY, TRAINING._TABLE, TRAINING_QUERY);
		sUriMatcher.addURI(AUTORITY, TRAINING._TABLE + "/#", TRAINING_ROW_QUERY);
		sUriMatcher.addURI(AUTORITY, EXERCISE._TABLE, EXERCISE_QUERY);
		sUriMatcher.addURI(AUTORITY, EXERCISE._TABLE + "/#", EXERCISE_ROW_QUERY);
		sUriMatcher.addURI(AUTORITY, TRAINING_TOTALS._TABLE, TRAINING_TOTALS_QUERY);
		sUriMatcher.addURI(AUTORITY, TRAINING_SETS._TABLE, TRAINING_SETS_QUERY);
		sUriMatcher.addURI(AUTORITY, TRAINING_SETS._TABLE + "/#", TRAINING_SETS_ROW_QUERY);
		sUriMatcher.addURI(AUTORITY, TRAINING_REPS._TABLE + "/#", TRAINING_REPS_QUERY);
	}
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		case TRAINING_QUERY: 
			...
			cursor.setNotificationUri(getContext().getContentResolver(), CONT_URI);
			return cursor;
...
//					null, null, null, null, TRAINING.TRAINING_ID + " DESC", null);
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		case TRAINING_QUERY:
			...
			getContext().getContentResolver().notifyChange(CONT_URI, null);
	...
	public int update(Uri uri, ContentValues values, String selection,
		...
		case TRAINING_ROW_QUERY:
			...
			if(rows > 0) getContext().getContentResolver().notifyChange(CONT_URI, null);
			return rows;
		case EXERCISE_ROW_QUERY:
