...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(savedInstanceState != null && savedInstanceState.containsKey(GymDb.ARGS.TRAIN_ID)) {
			//mTrainingId = savedInstanceState.getLong(GymDb.ARGS.TRAIN_ID);
			//TODO: clear fragments here
			showTraining(savedInstanceState.getLong(GymDb.ARGS.TRAIN_ID));
		} else {
			showTraining(null);
		}
	...
	protected void onSaveInstanceState(Bundle outState) {
		if(mTrainingId != null) 
			outState.putLong(GymDb.ARGS.TRAIN_ID, mTrainingId);
	...
	public void showTraining(Long id) {
		...
		if(mTrainingId != null) {
			...
			args.putLong(GymDb.ARGS.TRAIN_ID, mTrainingId);
